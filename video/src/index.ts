import { registerRoot, Composition, AbsoluteFill, useCurrentFrame, useVideoConfig, spring } from "remotion";
    ...
    <div style={ { opacity, transform: `scale(${scale})`, textAlign: "center" } }>
        <h1 style={ { fontSize: 180, margin: 0, fontWeight: 900 } }>
            MOUNT < span style = {{ color: "#333" }}> 0 </span>
                ...
                < h2 style = {{ fontSize: 60, margin: 20, fontWeight: 300, color: "#888" }}>
                    { subtitle }
                    </h2>
                    </div>
                    </AbsoluteFill>
