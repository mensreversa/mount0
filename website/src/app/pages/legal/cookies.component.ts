    ...
    <div class="container mx-auto px-6 py-24 pt-32">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="prose prose-invert max-w-none font-mono text-white/80">
          ...
          <p>This Cookie Policy explains how Mens Reversa Srl ("we", "us", or "our") uses cookies and similar technologies to recognize you when you visit our website at mount0.com ("Website"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
